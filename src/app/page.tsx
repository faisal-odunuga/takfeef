    ...
    <>
      ...
      <section className="py-24 text-center" style={{ background: "#faf6ee" }}>
        <div className="max-w-[1180px] mx-auto px-7">
          ...
          <Link
            href="/contact"
            className="inline-flex items-center justify-center px-10 py-4 rounded-sm text-white font-semibold text-[1rem] transition-all hover:opacity-90 active:scale-[0.98]"
